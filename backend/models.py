...
class TipoIncidente(str, Enum):
    ...
    secuestro = "Secuestro" # Añadí este de tu mockup
...
# Modelo para el Login (basado en el mockup image_63d73f.jpg)
class LoginData(BaseModel):
    correo: str  # O podría ser 'usuario' en lugar de 'correo'
    contrasena: str
